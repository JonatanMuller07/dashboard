...
export async function generateMetadata({ params }: PokemonPageProps): Promise<Metadata> {
    try {
        ...
        const { id, name } = await getPokemon(promiseParams.name);
        ...
        return {
            ...
            description: 'Lorem ipsum, dolor sit amet consectetur adipisicing elit. Iure voluptatum sapiente veniam nisi excepturi suscipit rem, facere labore iusto alias ex quo deleniti vel magni perferendis harum illo eaque inventore.'
        }
    }
}
...
const getPokemon = async (name: string): Promise<Pokemon> => {
    try {
        const pokemon = await fetch(`https://pokeapi.co/api/v2/pokemon/${name}`, {
            ...
            next: { revalidate: 60 * 60 * 30 * 6 } //Cada 6 meses se revalida }
        }).then(resp => resp.json());
